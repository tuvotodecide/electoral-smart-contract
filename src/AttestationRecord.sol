...
contract AttestationRecord is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor(address initialOwner) ERC721("AttestationRecord", "ART") {
        _grantRole(DEFAULT_ADMIN_ROLE, initialOwner);
    }

    function safeMint(address to, string memory uri) public onlyRole(AUTHORIZED_ROLE) returns (uint256) {
